...
const h1 = (...args) => React.createElement('h1', ...args);
const h2 = (...args) => React.createElement('h2', ...args);
...
createComp = function () {
  var comp = function () { return (null, 'Morearty rocks!'); };
    ...
    describe('#copy()', function () {
      ...
      it('should allow state sharing between multiple root components', function (done) {
        ...
        var comp1 = createClass({
          render: function () {
            render1CalledTimes++;
            return h1(null, this.getDefaultBinding().get('key'));
          }
        });
        ...
        var comp2 = createClass({
          render: function () {
            render2CalledTimes++;
            return h2(null, this.getDefaultBinding().get('key'));
          }
        });
